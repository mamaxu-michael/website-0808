    ...
    <div className="min-h-screen bg-[rgb(0,52,50)]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-[#98a2f8] bg-opacity-20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-[#98a2f8] border-opacity-30">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                {/* Credit Card */}
                <label className="flex items-center p-4 bg-white bg-opacity-30 hover:bg-opacity-40 rounded-xl cursor-pointer transition-all duration-300">
                  <input
                    type="radio"
                    name="payment"
                    value="credit-card"
                ...
                <label className="flex items-center p-4 bg-white bg-opacity-30 hover:bg-opacity-40 rounded-xl cursor-pointer transition-all duration-300">
                  <input
                    ...
                    className="mr-3 text-yellow-400"
                  />
                  <span className="text-black font-semibold">WeChat Pay</span>
                </label>
                ...
                <label className="flex items-center p-4 bg-white bg-opacity-30 hover:bg-opacity-40 rounded-xl cursor-pointer transition-all duration-300">
                  <input
                    ...
                    className="mr-3 text-yellow-400"
                  />
                  <span className="text-black font-semibold">Alipay</span>
                </label>
              </div>
            </div>
            ...
            {selectedPayment === 'credit-card' && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-black text-sm font-medium mb-2">Card Number</label>
                  <input
                    type="text"
                    placeholder="1234 5678 9012 3456"
                    className="w-full p-3 rounded-lg bg-white bg-opacity-50 text-black placeholder-gray-600 border border-black border-opacity-20 focus:border-yellow-600 focus:outline-none"
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-black text-sm font-medium mb-2">Expiry Date</label>
                    <input
                      type="text"
                      placeholder="MM/YY"
                      className="w-full p-3 rounded-lg bg-white bg-opacity-50 text-black placeholder-gray-600 border border-black border-opacity-20 focus:border-yellow-600 focus:outline-none"
                  ...
                  <div>
                    <label className="block text-black text-sm font-medium mb-2">CVV</label>
                    <input
                      type="text"
                      placeholder="123"
                      className="w-full p-3 rounded-lg bg-white bg-opacity-50 text-black placeholder-gray-600 border border-black border-opacity-20 focus:border-yellow-600 focus:outline-none"
                ...
                <div>
                  <label className="block text-black text-sm font-medium mb-2">Cardholder Name</label>
                  <input
                    type="text"
            ...
            {selectedPayment === 'stripe' && (
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-black mb-4">Stripe Payment</h3>
                <div>
                  <label className="block text-black text-sm font-medium mb-2">Card Number</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-black text-sm font-medium mb-2">CVC</label>
                    <input
                      type="text"
                      placeholder="123"
                      className="w-full p-3 rounded-lg bg-white bg-opacity-50 text-black placeholder-gray-600 border border-black border-opacity-20 focus:border-yellow-600 focus:outline-none"
            ...
            {selectedPayment === 'paypal' && (
              <div className="text-center p-8">
                ...
                <p className="text-black mb-4">You will be redirected to PayPal to complete your payment</p>
                <button className="bg-[#0070ba] hover:bg-[#005ea6] text-black px-6 py-3 rounded-lg font-semibold transition duration-300">
            ...
            {selectedPayment === 'wechat' && (
              <div className="text-center p-8">
                <h3 className="text-lg font-semibold text-white mb-4">Scan QR Code to Pay</h3>
                <div className="w-48 h-48 bg-[#9ef894] rounded-lg mx-auto flex items-center justify-center mb-4">
                  <div className="text-center">
                    <div className="text-4xl mb-2">📱</div>
                    <span className="text-gray-800 text-sm font-semibold">WeChat Pay QR</span>
                  </div>
                </div>
                <p className="text-black text-sm">Open WeChat and scan to pay $98</p>
              </div>
            )}
            ...
            {selectedPayment === 'alipay' && (
              <div className="text-center p-8">
                <h3 className="text-lg font-semibold text-white mb-4">Scan QR Code to Pay</h3>
                <div className="w-48 h-48 bg-[#c2f5f7] rounded-lg mx-auto flex items-center justify-center mb-4">
                  <div className="text-center">
                    <div className="text-4xl mb-2">📱</div>
                    <span className="text-gray-800 text-sm font-semibold">Alipay QR Code</span>
                  </div>
                </div>
                <p className="text-black text-sm">Open Alipay and scan to pay $98</p>
              </div>
            )}
          </div>

          {/* Right Column - Order Summary */}
          <div className="bg-[#9ef894] bg-opacity-15 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-[#9ef894] border-opacity-25">
            <h2 className="text-2xl font-bold text-white mb-6">Order Summary</h2>
            
            {/* Product Details */}
            <div className="bg-white bg-opacity-40 rounded-xl p-4 mb-6">
              <h3 className="text-lg font-bold text-black mb-2">Standard Plan</h3>
              <ul className="text-black text-sm space-y-1 opacity-90">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between items-center">
                <span className="text-black">Standard Plan (Monthly)</span>
                <span className="text-black">$98.00</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-black">Setup Fee</span>
              ...
              <p className="text-black text-sm opacity-70">Recurring monthly charge</p>
            </div>
            ...
            {/* Invoice Form */}
            {needInvoice && (
              <div className="space-y-4 mb-6 p-4 bg-white bg-opacity-30 rounded-xl">
                ...
                <div>
                  <label className="block text-black text-sm font-medium mb-2">Tax ID / VAT Number</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-black text-sm font-medium mb-2">Billing Email</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-black text-sm font-medium mb-2">Billing Address</label>
                  <textarea
                    rows={2}
            ...
            {/* Payment Button */}
            <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-[rgb(0,52,50)] py-4 rounded-lg font-bold text-lg transition duration-300 mb-4">
            ...
            {/* Security Notice */}
            <p className="text-black opacity-70 text-xs text-center">
